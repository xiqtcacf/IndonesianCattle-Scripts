#!/isdata/hellergrp/nzg134/programs/anaconda3/envs/snakemake/bin/python
import os
import sys
import glob
import json
...
def main(argv):
    ...
    subtypes = [k for k, v in jsons[0]['both'].items() if isinstance(v, dict) and k not in ('filters', 'totals')]
